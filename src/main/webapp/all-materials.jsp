		...
		$(document).ready(function () {
			...
			$(document).on("click", ".edit", function () {
				...
				$(".add").on("click", function () {
					...
					$.ajax({
						type: 'GET',
						url: 'materialUpdate?materialId=' + inputValues[0] + '&materialName=' + inputValues[1] + '&materialQuantity=' + inputValues[2] + '&materialPrice=' + inputValues[3] + '&oldID=' + arr[0],
									...
									<table class="datatable table table-stripped table table-hover table-center mb-0">
										<thead>
											...
											<%
												...
												ResultSet result = user.viewInventory("rawmaterial");
												try {
													while (result.next()) {
											%>
											<tr>
												...
												<td>
													...
													<a class="add" title="Add" data-material-id="<%= result.getInt("RawMaterialid")%>"><i class="material-icons">&#xE03B;</i></a>
