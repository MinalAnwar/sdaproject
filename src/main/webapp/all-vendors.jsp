										...
										<thead>
											...
											<tr>
												...
												<td>
													...
													<a class="delete" title="Delete" data-target="#delete_asset" onclick="sendRequestWithId(this)" data-vendor-id="<%= result.getInt("vendorId")%>"><i class="material-icons">&#xE872;</i></a>
												</td>
											</tr>
											<%
													}
...
<script>
	function sendRequestWithId(element) {
		var vendorId=element.getAttribute("data-vendor-id");
		...
		$('#delete_button_modal').on('click', function () {
			...
			$.ajax({
				type: 'GET',
				url: 'vendordelete?vendorID=' + vendorId,
				success: function (response) {
